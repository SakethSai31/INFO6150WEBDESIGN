...
function action(operand) {
    ...
    switch (operand) {
        ...
        case 1: result = ((x, y) => { return x + y; })(firstValue, secondValue); break;
        case 2: result = ((x, y) => { return x - y; })(firstValue, secondValue); break;
        case 3: result = ((x, y) => { return x * y; })(firstValue, secondValue); break;
        case 4: result = ((x, y) => { return x / y; })(firstValue, secondValue); break;
    }
    $('#result').val(result);
}
